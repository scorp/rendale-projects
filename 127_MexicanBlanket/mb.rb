  ...
  class Blanket  
    ...
    def initialize(width=75,height=100, scale=2)
      ...
      def generate_html
        ...
        pixel_array = []
        @ascii.split("").reject{|i|i=="\n"}.collect do |char|
           pixel_array.push "<div class=\"pixel\" style=\"background:#{@pattern.colors[char]}\"></div>\n"          
        end      
        @html += pixel_array.join
